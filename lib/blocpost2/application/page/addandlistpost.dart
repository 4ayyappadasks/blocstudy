...
class Addandlistpostwapper extends StatelessWidget {
  const Addandlistpostwapper({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<post2Bloc>(
      create: (context) => post2Bloc()..add(Getmethodevent()), // Initialize and add event
      child: Addandlistpost(),
    );
  }
}
                          ...
                          builder: (context, state) {
                            if (state is post2PostLoading) {
                              ...
                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                ...
                                tittle.clear(); // Clear the text field
                              });
                              return const Center(
